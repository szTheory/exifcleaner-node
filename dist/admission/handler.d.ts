...
import type { FormatCapabilities, Inspection, MetadataEntry, MetadataErrorDetails, MetadataWarning, Result } from "../types.js";
...
export interface FormatAdmission {
     ...
     */
    readonly resolutionNamespace: "EXIF" | "XMP" | "ICC" | "PNG" | "C2PA" | undefined;
}
type DistributiveOmit<T, K extends PropertyKey> = T extends unknown ? Omit<T, K> : never;
/** admissionDecline's error parameter, minus the `path` the caller supplies. */
export type AdmissionDeclineDetail = DistributiveOmit<MetadataErrorDetails, "path">;
/**
