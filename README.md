...
- Cleanup and timestamp operations identity-check the exclusively created destination; a replacement path is left untouched and reported as `destination-changed`.
